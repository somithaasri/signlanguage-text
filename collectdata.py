...
while True:
    ...
    count = {
             ...
             '1': len(os.listdir(directory+"/Bye")),
             '2': len(os.listdir(directory+"/Hi")),
             '3': len(os.listdir(directory+"/Iloveu")),
    ...
    if interrupt & 0xFF == ord('1'):
        cv2.imwrite(directory+'Bye/'+str(count['1'])+'.png',frame)
    if interrupt & 0xFF == ord('2'):
        cv2.imwrite(directory+'Hi/'+str(count['2'])+'.png',frame)
    if interrupt & 0xFF == ord('3'):
        cv2.imwrite(directory+'Iloveu/'+str(count['3'])+'.png',frame)
